...
var AutoDLLPlugin = function () {
  ...
  _createClass(AutoDLLPlugin, [{
    ...
    value: function apply(compiler) {
      ...
      var beforeCompile = function beforeCompile(params) {
      ...
      var watchRun = function watchRun(compiler) {
      ...
      var emit = function emit(compilation) {
      ...
      if (inject) {
        ...
        if (compiler.hooks) {
          compiler.hooks.compilation.tap('AutoDllPlugin', function (compilation) {
            compilation.hooks.htmlWebpackPluginBeforeHtmlGeneration.tap('AutoDllPlugin', doCompilation);
          });
        } else {
